...
from Avenger.database.notes_mongo import GetNote
...
from Avenger.helper.note_helper.note_misc_helper import preview_text_replace
from Avenger.plugins.connection.connection import connection
